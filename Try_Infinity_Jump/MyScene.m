...
//    SKSpriteNode * touchBtn;
//    SKSpriteNode * zoneBtn;
//    SKSpriteNode * bladeBtn;
...
//        gamePoint10BNode = [SKSpriteNode spriteNodeWithTexture:[self getTimeTexture:(gameScore)/10]];
//        gamePoint10BNode.anchorPoint = CGPointMake(0, 0);
//        gamePoint10BNode.size = CGSizeMake(gamePointNodeWH, gamePointNodeWH);
//        gamePoint10BNode.position = CGPointMake(gamePointX - gamePointNodeWH*10, gamePointY);
        
//        gamePoint100BNode = [SKSpriteNode spriteNodeWithTexture:[self getTimeTexture:(gameScore)/10]];
//        gamePoint100BNode.anchorPoint = CGPointMake(0, 0);
//        gamePoint100BNode.size = CGSizeMake(gamePointNodeWH, gamePointNodeWH);
//        gamePoint100BNode.position = CGPointMake(gamePointX - gamePointNodeWH*11, gamePointY);
...
//        [self addChild:gamePoint10BNode];
//        [self addChild:gamePoint100BNode];
...
//        touchBtn = [SKSpriteNode spriteNodeWithImageNamed:@"btnL_GameCenter-hd"];
//        touchBtn.size = CGSizeMake(42,42);
//        touchBtn.anchorPoint = CGPointMake(0, 0);
//        touchBtn.position = CGPointMake(self.frame.size.width - rankBtn.size.width, self.frame.size.height/2 - 42);
//        //        rankBtn.zPosition = backgroundLayerZPosition;
//        [self addChild:touchBtn];
//        
//        zoneBtn = [SKSpriteNode spriteNodeWithImageNamed:@"leader_board_btn"];
//        zoneBtn.size = CGSizeMake(42,42);
//        zoneBtn.anchorPoint = CGPointMake(0, 0);
//        zoneBtn.position = CGPointMake(self.frame.size.width - rankBtn.size.width, self.frame.size.height/2 - 42*2);
//        //        rankBtn.zPosition = backgroundLayerZPosition;
//        [self addChild:zoneBtn];
//        
//        bladeBtn = [SKSpriteNode spriteNodeWithImageNamed:@"leader_board_btn"];
//        bladeBtn.size = CGSizeMake(42,42);
//        bladeBtn.anchorPoint = CGPointMake(0, 0);
//        bladeBtn.position = CGPointMake(self.frame.size.width - rankBtn.size.width, self.frame.size.height/2 - 42*3);
//        //        rankBtn.zPosition = backgroundLayerZPosition;
//        [self addChild:bladeBtn];
    }
    return self;
}
...
//            if (CGRectContainsRect([zone calculateAccumulatedFrame], [bugs[i] calculateAccumulatedFrame])) {
//                //            isTouchAble = false;
//                isTouch = true;
//                
//                [self doKill:bugs[i]];
...
//-(void)show{
//    GameMenuViewController* gameMenuDialogViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"GameOverViewController"];
//    gameMenuDialogViewController.gameDelegate = self;
//    
//    gameMenuDialogViewController.gameTime = scene.gameTime;
//    
...
//    
//    self.view = gameMenuDialogViewController;
//    
//    [self.view presentViewController:gameMenuDialogViewController animated:YES completion:^{
//        //        [reset];
//    }];
//}
